...
CREATE VIEW [Forecasting].[Current_UVAQ_Best_View_Weekly_2015]
...
(select Flight_Plan_Record_ID, Volume_Forecast, [ISO_Week] as Media_Week   
 ...
 where MediaMonth_Year=2015) as subquery_volume  

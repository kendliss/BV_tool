...
CREATE VIEW Forecasting.Best_View_Monthly_Ryan_2013
...
FROM Forecasting.Best_View_Weekly_Agency_2013 
	INNER JOIN DIM.Media_Calendar ON Forecasting.Best_View_Weekly_Agency_2013 .Media_Week=DIM.Media_Calendar.[ISO_Week]
		WHERE ISO_Week_YYYYWW>201253 and Agency='Solution Set'
	GROUP BY 
	Project,
	Media_Type,
	Program_Owner,

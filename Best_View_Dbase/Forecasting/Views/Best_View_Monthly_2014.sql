...
CREATE VIEW [Forecasting].[Best_View_Monthly_2014]
...
FROM Forecasting.Current_UVAQ_Best_View_Weekly_2014
	INNER JOIN DIM.Media_Calendar ON Forecasting.Current_UVAQ_Best_View_Weekly_2014.Media_Week=DIM.Media_Calendar.[ISO_Week]
		WHERE ISO_Week_YYYYWW>201352 and ISO_Week_YYYYWW<201501
	GROUP BY 
	Project,
	Media_Type,
	Program_Owner,

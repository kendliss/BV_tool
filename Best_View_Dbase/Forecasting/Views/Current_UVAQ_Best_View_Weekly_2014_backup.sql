...
CREATE VIEW [Forecasting].[Current_UVAQ_Best_View_Weekly_2014_backup]
...
--Adjusted Actuals for Sales Lag   
 case when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) > DATEPART(wk,getdate())-1 then BV_Call_TV_Sales  
  when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-1 then  Actual_Call_TV/0.4  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-2 then  Actual_Call_TV/0.7  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-3 then  Actual_Call_TV/0.85  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-4 then  Actual_Call_TV/0.97  
     else Actual_Call_TV end as BV_Call_TV_Sales,   
 case when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) > DATEPART(wk,getdate())-1 then BV_Online_TV_Sales  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-1 then  Actual_Online_TV_Sales/0.4  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-2 then  Actual_Online_TV_Sales/0.7  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-3 then  Actual_Online_TV_Sales/0.85  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-4 then  Actual_Online_TV_Sales/0.97  
     else Actual_Online_TV_Sales end as BV_Online_TV_Sales,  
 case when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) > DATEPART(wk,getdate())-1 then BV_Call_HSIA_Sales  
  when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-1 then  Actual_Call_HSIA_Sales/0.4  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-2 then  Actual_Call_HSIA_Sales/0.7  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-3 then  Actual_Call_HSIA_Sales/0.85  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-4 then  Actual_Call_HSIA_Sales/0.97  
     else Actual_Call_HSIA_Sales end as BV_Call_HSIA_Sales,  
 case when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) > DATEPART(wk,getdate())-1 then BV_Online_HSIA_Sales  
    when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-1 then  Actual_Online_HSIA_Sales/0.4  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-2 then  Actual_Online_HSIA_Sales/0.7  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-3 then  Actual_Online_HSIA_Sales/0.85  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-4 then  Actual_Online_HSIA_Sales/0.97  
     else Actual_Online_HSIA_Sales end as BV_Online_HSIA_Sales,  
 case when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) > DATEPART(wk,getdate())-1 then BV_Call_VOIP_Sales  
  when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-1 then  Actual_Call_VOIP_Sales/0.4  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-2 then  Actual_Call_VOIP_Sales/0.7  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-3 then  Actual_Call_VOIP_Sales/0.85  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-4 then  Actual_Call_VOIP_Sales/0.97  
     else Actual_Call_VOIP_Sales end as BV_Call_VOIP_Sales,  
 case when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) > DATEPART(wk,getdate())-1 then BV_Online_VOIP_Sales  
    when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-1 then  Actual_Online_VOIP_Sales/0.4  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-2 then  Actual_Online_VOIP_Sales/0.7  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-3 then  Actual_Online_VOIP_Sales/0.85  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-4 then  Actual_Online_VOIP_Sales/0.97  
     else Actual_Online_VOIP_Sales end as BV_Online_VOIP_Sales,  
   
--------  
--amy add   
case when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) > DATEPART(wk,getdate())-1 then BV_Call_DSL_Reg_Sales  
    when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-1 then  Actual_Call_DSL_Reg_Sales/0.4  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-2 then  Actual_Call_DSL_Reg_Sales/0.7  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-3 then  Actual_Call_DSL_Reg_Sales/0.85  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-4 then  Actual_Call_DSL_Reg_Sales/0.97  
     else Actual_Call_DSL_Reg_Sales end as BV_Call_DSL_Reg_Sales,  
  
case when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) > DATEPART(wk,getdate())-1 then BV_Call_DSL_Dry_Sales  
    when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-1 then  Actual_Call_DSL_Dry_Sales/0.4  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-2 then  Actual_Call_DSL_Dry_Sales/0.7  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-2 then  Actual_Call_DSL_Dry_Sales/0.85  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-4 then  Actual_Call_DSL_Dry_Sales/0.97  
     else  Actual_Call_DSL_Dry_Sales end as BV_Call_DSL_Dry_Sales,  
       
       
case when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) > DATEPART(wk,getdate())-1 then BV_Call_Access_Sales  
    when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-1 then  Actual_Call_Access_Sales/0.4  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-2 then  Actual_Call_Access_Sales/0.7  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-3 then  Actual_Call_Access_Sales/0.85  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-4 then  Actual_Call_Access_Sales/0.97  
     else Actual_Call_Access_Sales end as BV_Call_Access_Sales,  
  
  
case when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) > DATEPART(wk,getdate())-1 then BV_Call_Wrls_Voice_Sales  
    when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-1 then  Actual_Call_Wrls_Voice_Sales/0.4  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-2 then  Actual_Call_Wrls_Voice_Sales/0.7  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-3 then  Actual_Call_Wrls_Voice_Sales/0.85  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-4 then  Actual_Call_Wrls_Voice_Sales/0.97  
     else Actual_Call_Wrls_Voice_Sales end as BV_Call_Wrls_Voice_Sales,  
  
case when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) > DATEPART(wk,getdate())-1 then BV_Call_Dish_Sales  
    when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-1 then  Actual_Call_Dish_Sales/0.4  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-2 then  Actual_Call_Dish_Sales/0.7  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-3 then  Actual_Call_Dish_Sales/0.85  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-4 then  Actual_Call_Dish_Sales/0.97  
     else Actual_Call_Dish_Sales end as BV_Call_Dish_Sales,  
  
case when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) > DATEPART(wk,getdate())-1 then BV_Call_WRLS_Family_Sales  
    when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-1 then  Actual_Call_WRLS_Family_Sales/0.4  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-2 then  Actual_Call_WRLS_Family_Sales/0.7  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-3 then  Actual_Call_WRLS_Family_Sales/0.85  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-4 then  Actual_Call_WRLS_Family_Sales/0.97  
     else Actual_Call_WRLS_Family_Sales end as BV_Call_WRLS_Family_Sales,  
  
case when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) > DATEPART(wk,getdate())-1 then BV_Call_WRLS_Data_Sales  
    when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-1 then  Actual_Call_WRLS_Data_Sales/0.4  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-2 then  Actual_Call_WRLS_Data_Sales/0.7  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-3 then  Actual_Call_WRLS_Data_Sales/0.85  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-4 then  Actual_Call_WRLS_Data_Sales/0.97  
     else Actual_Call_WRLS_Data_Sales end as BV_Call_WRLS_Data_Sales,  
  
case when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) > DATEPART(wk,getdate())-1 then BV_Call_IPDSL_Sales  
    when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-1 then  Actual_Call_IPDSL_Sales/0.4  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-2 then  Actual_Call_IPDSL_Sales/0.7  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-3 then  Actual_Call_IPDSL_Sales/0.85  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-4 then  Actual_Call_IPDSL_Sales/0.97  
     else Actual_Call_IPDSL_Sales end as BV_Call_IPDSL_Sales,  
  
case when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) > DATEPART(wk,getdate())-1 then BV_Online_DSL_Reg_Sales  
    when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-1 then  Actual_Online_DSL_Reg_Sales/0.4  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-2 then  Actual_Online_DSL_Reg_Sales/0.7  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-3 then  Actual_Online_DSL_Reg_Sales/0.85  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-4 then  Actual_Online_DSL_Reg_Sales/0.97  
     else  Actual_Online_DSL_Reg_Sales end as BV_Online_DSL_Reg_Sales,  
  
case when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) > DATEPART(wk,getdate())-1 then BV_Online_DSL_Dry_Sales  
    when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-1 then  Actual_Online_DSL_Dry_Sales/0.4  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-2 then  Actual_Online_DSL_Dry_Sales/0.7  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-3 then  Actual_Online_DSL_Dry_Sales/0.85  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-4 then  Actual_Online_DSL_Dry_Sales/0.97  
     else Actual_Online_DSL_Dry_Sales end as BV_Online_DSL_Dry_Sales,   
  
case when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) > DATEPART(wk,getdate())-1 then BV_Online_Access_Sales  
    when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-1 then  Actual_Online_Access_Sales/0.4  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-2 then  Actual_Online_Access_Sales/0.7  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-3 then  Actual_Online_Access_Sales/0.85  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-4 then  Actual_Online_Access_Sales/0.97  
     else  Actual_Online_Access_Sales end as BV_Online_Access_Sales,   
  
case when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) > DATEPART(wk,getdate())-1 then BV_Online_Wrls_Voice_Sales  
    when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-1 then  Actual_Online_Wrls_Voice_Sales/0.4  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-2 then  Actual_Online_Wrls_Voice_Sales/0.7  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-3 then  Actual_Online_Wrls_Voice_Sales/0.85  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-4 then  Actual_Online_Wrls_Voice_Sales/0.97  
     else  Actual_Online_Wrls_Voice_Sales end as BV_Online_Wrls_Voice_Sales,   
  
case when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) > DATEPART(wk,getdate())-1 then BV_Online_Dish_Sales  
    when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-1 then  Actual_Online_Dish_Sales/0.4  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-2 then  Actual_Online_Dish_Sales/0.7  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-3 then  Actual_Online_Dish_Sales/0.85  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-4 then  Actual_Online_Dish_Sales/0.97  
     else Actual_Online_Dish_Sales end as BV_Online_Dish_Sales,   
  
case when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) > DATEPART(wk,getdate())-1 then BV_Online_WRLS_Family_Sales  
    when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-1 then  Actual_Online_WRLS_Family_Sales/0.4  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-2 then  Actual_Online_WRLS_Family_Sales/0.7  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-3 then  Actual_Online_WRLS_Family_Sales/0.85  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-4 then  Actual_Online_WRLS_Family_Sales/0.97  
     else Actual_Online_WRLS_Family_Sales end as BV_Online_WRLS_Family_Sales,   
   
case when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) > DATEPART(wk,getdate())-1 then BV_Online_WRLS_Data_Sales  
    when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-1 then  Actual_Online_WRLS_Data_Sales/0.4  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-2 then  Actual_Online_WRLS_Data_Sales/0.7  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-3 then  Actual_Online_WRLS_Data_Sales/0.85  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-4 then  Actual_Online_WRLS_Data_Sales/0.97  
     else  Actual_Online_WRLS_Data_Sales end as BV_Online_WRLS_Data_Sales,  
  
case when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) > DATEPART(wk,getdate())-1 then BV_Online_IPDSL_Sales  
    when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-1 then  Actual_Online_IPDSL_Sales/0.4  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-2 then  Actual_Online_IPDSL_Sales/0.7  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-3 then  Actual_Online_IPDSL_Sales/0.85  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-4 then  Actual_Online_IPDSL_Sales/0.97  
     else Actual_Online_IPDSL_Sales end as BV_Online_IPDSL_Sales,  
 --end of amy add  
  
---------   
   
 case when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) > DATEPART(wk,getdate())-1 then BV_Directed_Strategic_Call_Sales  
    when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-1 then  Actual_Directed_Strategic_Call_Sales/0.4  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-2 then  Actual_Directed_Strategic_Call_Sales/0.7  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-3 then  Actual_Directed_Strategic_Call_Sales/0.85  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-4 then  Actual_Directed_Strategic_Call_Sales/0.97  
     else Actual_Directed_Strategic_Call_Sales end as BV_Directed_Strategic_Call_Sales,  
 case when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) > DATEPART(wk,getdate())-1 then BV_Directed_Strategic_Online_Sales  
   when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-1 then  Actual_Directed_Strategic_Online_Sales/0.4  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-2 then  Actual_Directed_Strategic_Online_Sales/0.7  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-3 then  Actual_Directed_Strategic_Online_Sales/0.85  
     when COALESCE(cv_BV_combo.Media_Week, actual.Media_Week) = DATEPART(wk,getdate())-4 then  Actual_Directed_Strategic_Online_Sales/0.97  

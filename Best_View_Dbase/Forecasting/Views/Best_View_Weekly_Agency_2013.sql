...
CREATE VIEW Forecasting.Best_View_Weekly_Agency_2013   
...
(SELECT  
 ...
 flight_plan_record.Agency as Agency, 
...
---Subquery to pull in the necessary information about the touch type----------------------------------  
  (SELECT Flight_Plan_Record_ID, Media_Type, Touch_Type_FK, Touch_Name, Touch_Name_2, Agency, Audience_Type_Name as Audience, Program_Owner, InHome_Date   
...
Commitment_Versions.CV_2013_February_Submission_Budget_Volume_Calls_Clicks_Sales_v2
 ...
 INNER JOIN   
---Subquery to pull in the necessary information about the touch type----------------------------------  
  (SELECT Touch_Type_ID, Agency  
    from Forecasting.Touch_Type) as agency_info   
 on cv_bill_resp.Touch_Type_FK=agency_info.Touch_Type_ID  
/*    
 LEFT JOIN  
...
and actual.Media_Week=cv_bv_combo.Media_Week and actual.InHome_Date=cv_bv_combo.InHome_Date and actual.agency=cv_bv_combo.agency  
and actual.Audience=cv_bv_combo.Audience and actual.touch_type_fk=cv_bv_combo.touch_type_fk

...
CREATE VIEW Forecasting.Best_Cut_Tactic
...
(Select  Best_Tactic_CPS_by_Decile.Touch_Type_FK
		...
		,Vol_by_Touch_Fcst.Decile_Volume_Forecast
...
(SELECT 
	   Volume_by_Touch.Flight_Plan_Record_ID
	  ,Volume_by_Touch.InHome_Date
	  ,Volume_by_Touch.[Month]
	  ,Volume_by_Touch.[Year]
	  ,Volume_by_Touch.Touch_Type_FK
	  ,Volume_by_Touch.Target_Type_Name
	  ,Volume_by_Touch.Percent_Target
	  ,(Volume_by_Touch.Volume_Forecast)/(Volume_by_Touch.Percent_Target*10) as Decile_Volume_Forecast
      ,Volume_by_Touch.CPP_Forecast
from
...
(SELECT Flight_Plan_Record_ID
	   ,Touch_Type_FK
       ,InHome_Date
       ,Decile_Targeted AS Decile_Targeted
...
Group by 
	  ...
	  ,Forecast_Volume.Touch_Type_FK
	  ,Forecast_Volume.Target_Type_Name
      ,Target_Deciles.Decile_Targeted) as Volume_by_Touch ) as Vol_by_Touch_Fcst

on Best_Tactic_CPS_by_Decile.Touch_Type_FK = Vol_by_Touch_Fcst.Touch_Type_FK and
   Best_Tactic_CPS_by_Decile.[Year] = Vol_by_Touch_Fcst.[Year] and
   Best_Tactic_CPS_by_Decile.[Month] = Vol_by_Touch_Fcst.[Month]
  
   
WHERE Best_Tactic_CPS_by_Decile.Percent_Target<Vol_by_Touch_Fcst.Percent_Target or Best_Tactic_CPS_by_Decile.Percent_Target=Vol_by_Touch_Fcst.Percent_Target

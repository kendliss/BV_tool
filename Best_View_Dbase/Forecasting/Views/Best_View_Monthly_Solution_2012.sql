...
CREATE VIEW Forecasting.[Best_View_Monthly_Solution_2012]
...
FROM Forecasting.Best_View_Weekly_Agency
	...
	WHERE ISO_Week_YYYYWW>201153  and iso_week_yyyyWW< 201301 and Media_Type not in ('SharedM','SMS') and agency='Solution Set'

...
CREATE VIEW [Forecasting].[Current_UVAQ_Flightplan_Forecast_View] WITH SCHEMABINDING

AS SELECT DISTINCT  Current_UVAQ_Flightplan.Flight_Plan_Record_ID, prj450_job_cd, Current_UVAQ_Flightplan.InHome_Date, 
	Current_UVAQ_Flightplan.Volume_Date, Current_UVAQ_Flightplan.Touch_Type_FK, Current_UVAQ_Flightplan.Media_Type, Current_UVAQ_Flightplan.Target_Type_Name, 
	Current_UVAQ_Flightplan.Touch_Name, Current_UVAQ_Flightplan.Touch_Name_2,Current_UVAQ_Flightplan.Audience_Type_Name,
...
---Volume Calculations   
   ...
   WHEN Target_Type_Name = 'PERCENT' AND Media_Type='EM' and Touch_Name_2 in ('TV Upsell initials') AND inhome_date>'2012-12-30' THEN Forecasting.[2013_Lead_Forecast].TV_Upsell_Leads*Target_Value*0.5
   ...
   WHEN Target_Type_Name = 'PERCENT' AND Media_Type='EM' and Touch_Name_2 like '%TV Upsell Engagement%' AND inhome_date>'2012-12-30' THEN (52000.0 * (month(inhome_date)+12.0) + 640285.0) * Target_Value*0.45*0.2
...
----2013 Specific Forecasting---- 
	...
	-----Recurring------  
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type in ('DM') and Audience_Type_Name='Wrls Oly' THEN (Forecasting.[2013_Lead_Forecast].DMDR_leads*Target_Value-30725)
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type in ('CA','DM') and Audience_Type_Name='Wrls IRU' THEN (Forecasting.[2013_Lead_Forecast].IRU_leads*Target_Value-31914)
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type in ('CA','DM') and Audience_Type_Name='Wln Mix' THEN (Forecasting.[2013_Lead_Forecast].LT_leads*Target_Value-52990)
   ...
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type in ('DM') and Audience_Type_Name='Span_Tag' THEN (Forecasting.[2013_Lead_Forecast].Spanish_2_3*Target_Value-4370)
   
  
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Initial%' and Audience_Type_Name='Wrls IRU' THEN Forecasting.[2013_Lead_Forecast].IRU_leads*Target_Value*0.3
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Initial%' and Audience_Type_Name='Wln Mix' THEN (Forecasting.[2013_Lead_Forecast].LT_leads+Forecasting.[2013_Lead_Forecast].DMDR_leads+Forecasting.[2013_Lead_Forecast].Spanish_leads+Forecasting.[2013_Lead_Forecast].Recur_NG_leads)*Target_Value*0.3
   
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Reblast%' and Audience_Type_Name='Wrls IRU' THEN Forecasting.[2013_Lead_Forecast].IRU_leads*Target_Value*0.3*.9
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Reblast%' and Audience_Type_Name='Wln Mix' THEN (Forecasting.[2013_Lead_Forecast].LT_leads+Forecasting.[2013_Lead_Forecast].DMDR_leads+Forecasting.[2013_Lead_Forecast].Spanish_leads+Forecasting.[2013_Lead_Forecast].Recur_NG_leads)*Target_Value*0.3*.9

   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Engage%' and Audience_Type_Name='Wrls IRU' THEN Forecasting.[2013_Lead_Forecast].IRU_leads*Target_Value*0.3*0.1
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Engage%' and Audience_Type_Name='Wln Mix' THEN (Forecasting.[2013_Lead_Forecast].LT_leads+Forecasting.[2013_Lead_Forecast].DMDR_leads+Forecasting.[2013_Lead_Forecast].Spanish_leads+Forecasting.[2013_Lead_Forecast].Recur_NG_leads)*Target_Value*0.3*0.1
...
---Budget Calculations
   ...
   WHEN Target_Type_Name = 'PERCENT' AND Media_Type='EM' and Touch_Name_2 in ('TV Upsell initials') AND inhome_date>'2012-12-30' THEN Forecasting.[2013_Lead_Forecast].TV_Upsell_Leads*Target_Value*0.5* Cost_Per_Piece 
   ...
   WHEN Target_Type_Name = 'PERCENT' AND Media_Type='EM' and Touch_Name_2 like '%TV Upsell Engagement%' AND inhome_date>'2012-12-30' THEN (52000.0 * (month(inhome_date)+12.0) + 640285.0) * Target_Value*0.45*0.2 * Cost_Per_Piece 
...
----2013 Specific Forecasting---- 
	...
	-----Recurring------  
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type in ('DM') and Audience_Type_Name='Wrls Oly' THEN (Forecasting.[2013_Lead_Forecast].DMDR_leads*Target_Value-30725) * Cost_Per_Piece
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type in ('CA','DM') and Audience_Type_Name='Wrls IRU' THEN (Forecasting.[2013_Lead_Forecast].IRU_leads*Target_Value-31914) * Cost_Per_Piece
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type in ('CA','DM') and Audience_Type_Name='Wln Mix' THEN (Forecasting.[2013_Lead_Forecast].LT_leads*Target_Value-52990) * Cost_Per_Piece
   ...
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type in ('CA') and Audience_Type_Name='Wrls Oly' THEN Forecasting.[2013_Lead_Forecast].DMDR_leads *Target_Value * Cost_Per_Piece
      WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type in ('DM') and Audience_Type_Name='Span_Tag' THEN (Forecasting.[2013_Lead_Forecast].Spanish_2_3*Target_Value-4370) * Cost_Per_Piece
    
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Initial%' and Audience_Type_Name='Wrls IRU' THEN Forecasting.[2013_Lead_Forecast].IRU_leads*Target_Value*0.3* Cost_Per_Piece
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Initial%' and Audience_Type_Name='Wln Mix' THEN (Forecasting.[2013_Lead_Forecast].LT_leads+Forecasting.[2013_Lead_Forecast].DMDR_leads+Forecasting.[2013_Lead_Forecast].Spanish_leads+Forecasting.[2013_Lead_Forecast].Recur_NG_leads)*Target_Value*0.3* Cost_Per_Piece
   
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Reblast%' and Audience_Type_Name='Wrls IRU' THEN Forecasting.[2013_Lead_Forecast].IRU_leads*Target_Value*0.3*.9* Cost_Per_Piece
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Reblast%' and Audience_Type_Name='Wln Mix' THEN (Forecasting.[2013_Lead_Forecast].LT_leads+Forecasting.[2013_Lead_Forecast].DMDR_leads+Forecasting.[2013_Lead_Forecast].Spanish_leads+Forecasting.[2013_Lead_Forecast].Recur_NG_leads)*Target_Value*0.3*0.9* Cost_Per_Piece

   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Engage%' and Audience_Type_Name='Wrls IRU' THEN Forecasting.[2013_Lead_Forecast].IRU_leads*Target_Value*0.3*0.1* Cost_Per_Piece
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Engage%' and Audience_Type_Name='Wln Mix' THEN (Forecasting.[2013_Lead_Forecast].LT_leads+Forecasting.[2013_Lead_Forecast].DMDR_leads+Forecasting.[2013_Lead_Forecast].Spanish_leads+Forecasting.[2013_Lead_Forecast].Recur_NG_leads)*Target_Value*0.3*0.1* Cost_Per_Piece

   WHEN Target_Type_Name = 'BUDGET' THEN Target_Value
   END AS Budget_Forecast,
---Call Response Calculations
 Case when inhome_date>='2014-09-21' then --edit for allowance of offer loss (cut rates by a percentage for all)
   (CASE WHEN Target_Type_Name = 'VOLUME' and media_type='DM' and InHome_Date='2014-04-17' THEN Target_Value * Call_RR.Response_Rate * Adjustment_Factor*Seasonality_Index*.9
	WHEN Target_Type_Name = 'VOLUME' THEN Target_Value * Call_RR.Response_Rate * Adjustment_Factor*Seasonality_Index
   ...
   WHEN Target_Type_Name = 'PERCENT' AND Media_Type='EM' and Touch_Name_2 in ('TV Upsell initials') AND inhome_date>'2012-12-30' THEN Forecasting.[2013_Lead_Forecast].TV_Upsell_Leads*Target_Value*0.5 * Call_RR.Response_Rate*Seasonality_Index
   ...
   WHEN Target_Type_Name = 'PERCENT' AND Media_Type='EM' and Touch_Name_2 like '%TV Upsell Engagement%' AND inhome_date>'2012-12-30' THEN (52000.0 * (month(inhome_date)+12.0) + 640285.0) * Target_Value*0.45*0.2 * Call_RR.Response_Rate*Seasonality_Index
...
----2013 Specific Forecasting---- 
   ...
   WHEN Target_Type_Name = 'PERCENT' and INHome_date in ('2013-08-27', '2013-10-28', '2013-02-25') and touch_name not like '%Touch%' and media_Type in ('DM') and Audience_Type_Name='Wrls Oly' THEN (Forecasting.[2013_Lead_Forecast].DMDR_leads*Target_Value-30725) * Call_RR.Response_Rate * 0.875 * Adjustment_Factor*Seasonality_Index
   ...
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type in ('DM') and Audience_Type_Name='Wrls Oly' THEN (Forecasting.[2013_Lead_Forecast].DMDR_leads*Target_Value-30725) * Call_RR.Response_Rate * Adjustment_Factor*Seasonality_Index
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type in ('CA','DM') and Audience_Type_Name='Wrls IRU' THEN (Forecasting.[2013_Lead_Forecast].IRU_leads*Target_Value-31914) * Call_RR.Response_Rate * Adjustment_Factor*Seasonality_Index
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type in ('CA','DM') and Audience_Type_Name='Wln Mix' THEN (Forecasting.[2013_Lead_Forecast].LT_leads*Target_Value-52990) * Call_RR.Response_Rate * Adjustment_Factor*Seasonality_Index
      WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type in ('DM') and Audience_Type_Name='Span_Tag' THEN (Forecasting.[2013_Lead_Forecast].Spanish_2_3*Target_Value-4370) * Call_RR.Response_Rate * Adjustment_Factor*Seasonality_Index
   ...
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Initial%' and Audience_Type_Name='Wrls IRU' THEN Forecasting.[2013_Lead_Forecast].IRU_leads*Target_Value*0.3 * Call_RR.Response_Rate*Seasonality_Index
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Initial%' and Audience_Type_Name='Wln Mix' THEN (Forecasting.[2013_Lead_Forecast].LT_leads+Forecasting.[2013_Lead_Forecast].DMDR_leads+Forecasting.[2013_Lead_Forecast].Spanish_leads+Forecasting.[2013_Lead_Forecast].Recur_NG_leads)*Target_Value*0.3 * Call_RR.Response_Rate*Seasonality_Index
   
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Reblast%' and Audience_Type_Name='Wrls IRU' THEN Forecasting.[2013_Lead_Forecast].IRU_leads*Target_Value*0.3*.9 * Call_RR.Response_Rate*Seasonality_Index
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Reblast%' and Audience_Type_Name='Wln Mix' THEN (Forecasting.[2013_Lead_Forecast].LT_leads+Forecasting.[2013_Lead_Forecast].DMDR_leads+Forecasting.[2013_Lead_Forecast].Spanish_leads+Forecasting.[2013_Lead_Forecast].Recur_NG_leads)*Target_Value*0.3*.9 * Call_RR.Response_Rate*Seasonality_Index

   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Engage%' and Audience_Type_Name='Wrls IRU' THEN Forecasting.[2013_Lead_Forecast].IRU_leads*Target_Value*0.3*0.1 * Call_RR.Response_Rate*Seasonality_Index
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Engage%' and Audience_Type_Name='Wln Mix' THEN (Forecasting.[2013_Lead_Forecast].LT_leads+Forecasting.[2013_Lead_Forecast].DMDR_leads+Forecasting.[2013_Lead_Forecast].Spanish_leads+Forecasting.[2013_Lead_Forecast].Recur_NG_leads)*Target_Value*0.3*0.1 * Call_RR.Response_Rate*Seasonality_Index
...
---Click Response Calculations
 Case when inhome_date>='2014-09-21' then --edit for allowance of offer loss (cut rates by a percentage for all)
   (CASE WHEN Target_Type_Name = 'VOLUME' and media_type='DM' and InHome_Date='2014-04-17' THEN Target_Value * Adjustment_Factor * Click_RR.Response_Rate*Seasonality_Index*.9
	WHEN Target_Type_Name = 'VOLUME' THEN Target_Value * Adjustment_Factor * Click_RR.Response_Rate*Seasonality_Index
   ...
   WHEN Target_Type_Name = 'PERCENT' AND Media_Type='EM' and Touch_Name_2 in ('TV Upsell initials') AND inhome_date>'2012-12-30' THEN Forecasting.[2013_Lead_Forecast].TV_Upsell_Leads*Target_Value*0.5* Click_RR.Response_Rate*Seasonality_Index
   ...
   WHEN Target_Type_Name = 'PERCENT' AND Media_Type='EM' and Touch_Name_2 like '%TV Upsell Engagement%' AND inhome_date>'2012-12-30' THEN (52000.0 * (month(inhome_date)+12.0) + 640285.0) * Target_Value*0.45*0.2 * Click_RR.Response_Rate*Seasonality_Index
...
----2013 Specific Forecasting---- 
	...
	-----Recurring------  
               ------ADDED -10% Adjustment for Months Following a Catalog-----
   WHEN Target_Type_Name = 'PERCENT' and INHome_date in ('2013-08-27', '2013-10-28', '2013-02-25') and touch_name not like '%Touch%' and media_Type in ('DM') and Audience_Type_Name='Wrls Oly' THEN (Forecasting.[2013_Lead_Forecast].DMDR_leads*Target_Value-30725)* Click_RR.Response_Rate* 0.875 * Adjustment_Factor*Seasonality_Index
   ...
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type in ('DM') and Audience_Type_Name='Wrls Oly' THEN (Forecasting.[2013_Lead_Forecast].DMDR_leads*Target_Value-30725)* Click_RR.Response_Rate* Adjustment_Factor*Seasonality_Index
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type in ('CA','DM') and Audience_Type_Name='Wrls IRU' THEN (Forecasting.[2013_Lead_Forecast].IRU_leads*Target_Value-31914)* Click_RR.Response_Rate* Adjustment_Factor*Seasonality_Index
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type in ('CA','DM') and Audience_Type_Name='Wln Mix' THEN (Forecasting.[2013_Lead_Forecast].LT_leads*Target_Value-52990)* Click_RR.Response_Rate* Adjustment_Factor*Seasonality_Index
   ...
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type in ('CA','DM') and Audience_Type_Name='Wln NG' THEN Forecasting.[2013_Lead_Forecast].Recur_NG_leads*Target_Value* Click_RR.Response_Rate* Adjustment_Factor*Seasonality_Index
    ...
    WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type in ('DM') and Audience_Type_Name='Span_Tag' THEN (Forecasting.[2013_Lead_Forecast].Spanish_2_3*Target_Value-4370) * Click_RR.Response_Rate * Adjustment_Factor*Seasonality_Index
        
    
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Initial%' and Audience_Type_Name='Wrls IRU' THEN Forecasting.[2013_Lead_Forecast].IRU_leads*Target_Value*0.3* Click_RR.Response_Rate*Seasonality_Index
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Initial%' and Audience_Type_Name='Wln Mix' THEN (Forecasting.[2013_Lead_Forecast].LT_leads+Forecasting.[2013_Lead_Forecast].DMDR_leads+Forecasting.[2013_Lead_Forecast].Spanish_leads+Forecasting.[2013_Lead_Forecast].Recur_NG_leads)*Target_Value*0.3* Click_RR.Response_Rate*Seasonality_Index
   
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Reblast%' and Audience_Type_Name='Wrls IRU' THEN Forecasting.[2013_Lead_Forecast].IRU_leads*Target_Value*0.3*.9* Click_RR.Response_Rate*Seasonality_Index
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Reblast%' and Audience_Type_Name='Wln Mix' THEN (Forecasting.[2013_Lead_Forecast].LT_leads+Forecasting.[2013_Lead_Forecast].DMDR_leads+Forecasting.[2013_Lead_Forecast].Spanish_leads+Forecasting.[2013_Lead_Forecast].Recur_NG_leads)*Target_Value*0.3*.9* Click_RR.Response_Rate*Seasonality_Index

   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Engage%' and Audience_Type_Name='Wrls IRU' THEN Forecasting.[2013_Lead_Forecast].IRU_leads*Target_Value*0.3*0.1* Click_RR.Response_Rate*Seasonality_Index
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Engage%' and Audience_Type_Name='Wln Mix' THEN (Forecasting.[2013_Lead_Forecast].LT_leads+Forecasting.[2013_Lead_Forecast].DMDR_leads+Forecasting.[2013_Lead_Forecast].Spanish_leads+Forecasting.[2013_Lead_Forecast].Recur_NG_leads)*Target_Value*0.3*0.1* Click_RR.Response_Rate*Seasonality_Index
...
-------------------------------------------------------------------------------------------------------------------------------
/*Space break for readability between Click and Call Forecast
...
---Call Sales Calculations
 Case when inhome_date>='2014-09-21' then --edit for allowance of offer loss (cut rates by a percentage for all)
   (CASE WHEN Target_Type_Name = 'VOLUME' and media_type='DM' and InHome_Date='2014-04-17' THEN Target_Value * Call_RR.Response_Rate * Adjustment_Factor  * Call_CR.Conversion_Rate*Seasonality_Index*.9
    WHEN Target_Type_Name = 'VOLUME' THEN Target_Value * Call_RR.Response_Rate * Adjustment_Factor  * Call_CR.Conversion_Rate*Seasonality_Index
   ...
   WHEN Target_Type_Name = 'PERCENT' AND Media_Type='EM' and Touch_Name_2 in ('TV Upsell initials') AND inhome_date>'2012-12-30' THEN Forecasting.[2013_Lead_Forecast].TV_Upsell_Leads*Target_Value*0.5 * Call_RR.Response_Rate * Call_CR.Conversion_Rate*Seasonality_Index
   ...
   WHEN Target_Type_Name = 'PERCENT' AND Media_Type='EM' and Touch_Name_2 like '%TV Upsell Engagement%' AND inhome_date>'2012-12-30' THEN (52000.0 * (month(inhome_date)+12.0) + 640285.0) * Target_Value*0.45*0.2 * Call_RR.Response_Rate * Call_CR.Conversion_Rate*Seasonality_Index
...
----2013 Specific Forecasting---- 
	...
	-----Recurring------  
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type in ('DM') and Audience_Type_Name='Wrls Oly' THEN (Forecasting.[2013_Lead_Forecast].DMDR_leads*Target_Value-30725) * Call_RR.Response_Rate * Adjustment_Factor  * Call_CR.Conversion_Rate*Seasonality_Index
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type in ('CA','DM') and Audience_Type_Name='Wrls IRU' THEN (Forecasting.[2013_Lead_Forecast].IRU_leads*Target_Value-31914) * Call_RR.Response_Rate * Adjustment_Factor  * Call_CR.Conversion_Rate*Seasonality_Index
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type in ('CA','DM') and Audience_Type_Name='Wln Mix' THEN (Forecasting.[2013_Lead_Forecast].LT_leads*Target_Value-52990) * Call_RR.Response_Rate * Adjustment_Factor  * Call_CR.Conversion_Rate*Seasonality_Index
   ...
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type in ('CA','DM') and Audience_Type_Name='Wln NG' THEN Forecasting.[2013_Lead_Forecast].Recur_NG_leads*Target_Value * Call_RR.Response_Rate * Adjustment_Factor  * Call_CR.Conversion_Rate*Seasonality_Index
    WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type in ('CA') and Audience_Type_Name='Wrls Oly' THEN Forecasting.[2013_Lead_Forecast].DMDR_leads* Target_Value * Call_RR.Response_Rate * Adjustment_Factor  * Call_CR.Conversion_Rate*Seasonality_Index
     WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type in ('DM') and Audience_Type_Name='Span_Tag' THEN (Forecasting.[2013_Lead_Forecast].Spanish_2_3*Target_Value-4370) * Call_RR.Response_Rate * Adjustment_Factor  * Call_CR.Conversion_Rate*Seasonality_Index
   
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Initial%' and Audience_Type_Name='Wrls IRU' THEN Forecasting.[2013_Lead_Forecast].IRU_leads*Target_Value*0.3* Call_RR.Response_Rate* Call_CR.Conversion_Rate*Seasonality_Index
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Initial%' and Audience_Type_Name='Wln Mix' THEN (Forecasting.[2013_Lead_Forecast].LT_leads+Forecasting.[2013_Lead_Forecast].DMDR_leads+Forecasting.[2013_Lead_Forecast].Spanish_leads+Forecasting.[2013_Lead_Forecast].Recur_NG_leads)*Target_Value*0.3* Call_RR.Response_Rate* Call_CR.Conversion_Rate*Seasonality_Index
   
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Reblast%' and Audience_Type_Name='Wrls IRU' THEN Forecasting.[2013_Lead_Forecast].IRU_leads*Target_Value*0.3*.9* Call_RR.Response_Rate* Call_CR.Conversion_Rate*Seasonality_Index
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Reblast%' and Audience_Type_Name='Wln Mix' THEN (Forecasting.[2013_Lead_Forecast].LT_leads+Forecasting.[2013_Lead_Forecast].DMDR_leads+Forecasting.[2013_Lead_Forecast].Spanish_leads+Forecasting.[2013_Lead_Forecast].Recur_NG_leads)*Target_Value*0.3*.9* Call_RR.Response_Rate* Call_CR.Conversion_Rate*Seasonality_Index

   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Engage%' and Audience_Type_Name='Wrls IRU' THEN Forecasting.[2013_Lead_Forecast].IRU_leads*Target_Value*0.3*0.1* Call_RR.Response_Rate* Call_CR.Conversion_Rate*Seasonality_Index
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Engage%' and Audience_Type_Name='Wln Mix' THEN (Forecasting.[2013_Lead_Forecast].LT_leads+Forecasting.[2013_Lead_Forecast].DMDR_leads+Forecasting.[2013_Lead_Forecast].Spanish_leads+Forecasting.[2013_Lead_Forecast].Recur_NG_leads)*Target_Value*0.3*0.1* Call_RR.Response_Rate* Call_CR.Conversion_Rate*Seasonality_Index
...
---Click Sales Calculations 
 Case when inhome_date>='2014-09-21' then --edit for allowance of offer loss (cut rates by a percentage for all)
   (CASE WHEN Target_Type_Name = 'VOLUME' and media_type='DM' and InHome_Date='2014-04-17' THEN Target_Value * Click_RR.Response_Rate * Click_CR.Conversion_Rate * Adjustment_Factor*Seasonality_Index *.9
	WHEN Target_Type_Name = 'VOLUME' THEN Target_Value * Click_RR.Response_Rate * Click_CR.Conversion_Rate * Adjustment_Factor*Seasonality_Index
   ...
   WHEN Target_Type_Name = 'PERCENT' AND Media_Type='EM' and Touch_Name_2 in ('TV Upsell initials') AND inhome_date>'2012-12-30' THEN Forecasting.[2013_Lead_Forecast].TV_Upsell_Leads*Target_Value*0.5* Click_RR.Response_Rate * Click_CR.Conversion_Rate*Seasonality_Index
   ...
   WHEN Target_Type_Name = 'PERCENT' AND Media_Type='EM' and Touch_Name_2 like '%TV Upsell Engagement%' AND inhome_date>'2012-12-30' THEN (52000.0 * (month(inhome_date)+12.0) + 640285.0) * Target_Value*0.45*0.2* Click_RR.Response_Rate * Click_CR.Conversion_Rate*Seasonality_Index
...
----2013 Specific Forecasting---- 
	...
	-----Recurring------  
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type in ('DM') and Audience_Type_Name='Wrls Oly' THEN (Forecasting.[2013_Lead_Forecast].DMDR_leads*Target_Value-30725)* Click_RR.Response_Rate* Adjustment_Factor * Click_CR.Conversion_Rate*Seasonality_Index
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type in ('CA','DM') and Audience_Type_Name='Wrls IRU' THEN (Forecasting.[2013_Lead_Forecast].IRU_leads*Target_Value-31914)* Click_RR.Response_Rate* Adjustment_Factor * Click_CR.Conversion_Rate*Seasonality_Index
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type in ('CA','DM') and Audience_Type_Name='Wln Mix' THEN (Forecasting.[2013_Lead_Forecast].LT_leads*Target_Value-52990)* Click_RR.Response_Rate* Adjustment_Factor * Click_CR.Conversion_Rate*Seasonality_Index
   ...
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type in ('DM') and Audience_Type_Name='Span_Tag' THEN (Forecasting.[2013_Lead_Forecast].Spanish_2_3*Target_Value-4370) * Call_RR.Response_Rate * Adjustment_Factor  * Click_CR.Conversion_Rate*Seasonality_Index
   
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Initial%' and Audience_Type_Name='Wrls IRU' THEN Forecasting.[2013_Lead_Forecast].IRU_leads*Target_Value*0.3 * Click_RR.Response_Rate * Click_CR.Conversion_Rate*Seasonality_Index
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Initial%' and Audience_Type_Name='Wln Mix' THEN (Forecasting.[2013_Lead_Forecast].LT_leads+Forecasting.[2013_Lead_Forecast].DMDR_leads+Forecasting.[2013_Lead_Forecast].Spanish_leads+Forecasting.[2013_Lead_Forecast].Recur_NG_leads)*Target_Value*0.3 * Click_RR.Response_Rate * Click_CR.Conversion_Rate*Seasonality_Index
   
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Reblast%' and Audience_Type_Name='Wrls IRU' THEN Forecasting.[2013_Lead_Forecast].IRU_leads*Target_Value*0.3*.9 * Click_RR.Response_Rate * Click_CR.Conversion_Rate*Seasonality_Index
   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Reblast%' and Audience_Type_Name='Wln Mix' THEN (Forecasting.[2013_Lead_Forecast].LT_leads+Forecasting.[2013_Lead_Forecast].DMDR_leads+Forecasting.[2013_Lead_Forecast].Spanish_leads+Forecasting.[2013_Lead_Forecast].Recur_NG_leads)*Target_Value*0.3*.9 * Click_RR.Response_Rate * Click_CR.Conversion_Rate*Seasonality_Index

   WHEN Target_Type_Name = 'PERCENT' and INHome_date>='2012-12-31' and touch_name not like '%Touch%' and media_Type='EM' and touch_name_2 like '%Engage%' and Audience_Type_Name='Wrls IRU' THEN Forecasting.[2013_Lead_Forecast].IRU_leads*Target_Value*0.3*0.1 * Click_RR.Response_Rate * Click_CR.Conversion_Rate*Seasonality_Index
...
---General Error Check Information
 ...
 FROM          Forecasting.Current_UVAQ_Flightplan LEFT JOIN
 
 ---Volume Linkages
              DIM.Media_Calendar_Daily 
					ON Forecasting.Current_UVAQ_Flightplan.Volume_Date = DIM.Media_Calendar_Daily.[Date] LEFT OUTER JOIN
              Forecasting.Current_MLP_Summary_View 
					ON datepart(year,Forecasting.Current_UVAQ_Flightplan.Volume_Date) = Forecasting.Current_MLP_Summary_View.MLP_Year AND 
					datepart(month,Forecasting.Current_UVAQ_Flightplan.Volume_Date) = Forecasting.Current_MLP_Summary_View.MLP_Month LEFT OUTER JOIN
              Forecasting.Most_Recent_Volume_Assumptions 
					ON Forecasting.Current_UVAQ_Flightplan.Touch_Type_FK = Forecasting.Most_Recent_Volume_Assumptions.Touch_Type_FK LEFT OUTER JOIN
			  ...
			  Forecasting.[2013_Lead_Forecast]
					ON  Forecasting.Current_UVAQ_Flightplan.Inhome_MediaMonth= Forecasting.[2013_Lead_Forecast].Month_Leads AND
					Forecasting.Current_UVAQ_Flightplan.Inhome_MediaMonth_Year=Forecasting.[2013_Lead_Forecast].Year_Leads LEFT OUTER JOIN
			  
---Budget and CPP Linkage
			  Forecasting.Most_Recent_CPP_Assumptions
					ON Forecasting.Current_UVAQ_Flightplan.Touch_Type_FK = Forecasting.Most_Recent_CPP_Assumptions.Touch_Type_FK LEFT OUTER JOIN
					
---Response Rate Linkage
			  Forecasting.Most_Recent_RR_Assumptions AS Call_RR
					ON Forecasting.Current_UVAQ_Flightplan.Touch_Type_FK = Call_RR.Touch_Type_FK and Call_RR.Response_Channel_FK=1 LEFT OUTER JOIN
			  Forecasting.Most_Recent_RR_Assumptions AS Click_RR
					ON Forecasting.Current_UVAQ_Flightplan.Touch_Type_FK = Click_RR.Touch_Type_FK and Click_RR.Response_Channel_FK=2 LEFT OUTER JOIN
			  Forecasting.Most_Recent_Decile_Adjustments
					ON Forecasting.Current_UVAQ_Flightplan.Touch_Type_FK = Forecasting.Most_Recent_Decile_Adjustments.Touch_Type_FK 
					and ROUND(Forecasting.Current_UVAQ_Flightplan.Decile_Targeted,1)=ROUND(ROUND(Forecasting.Most_Recent_Decile_Adjustments.Percent_Target,1)*10,1) LEFT OUTER JOIN

---Conversion Rate Linkage
			  Forecasting.Most_Recent_Conversions_View AS Call_CR
					ON Forecasting.Current_UVAQ_Flightplan.Touch_Type_FK = Call_CR.Touch_Type_FK and Call_CR.Response_Channel_FK=1 LEFT OUTER JOIN
			  Forecasting.Most_Recent_Conversions_View AS Click_CR
					ON Forecasting.Current_UVAQ_Flightplan.Touch_Type_FK = Click_CR.Touch_Type_FK and Click_CR.Response_Channel_FK=2 LEFT OUTER JOIN

---Seasonality Linkage
			  Forecasting.Seasonality as Seasonality
					ON Forecasting.Current_UVAQ_Flightplan.Media_Type_FK=Seasonality.Media_Type_FK and month(Forecasting.Current_UVAQ_Flightplan.inhome_date)=Seasonality.Seasonality_Month

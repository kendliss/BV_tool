...
CREATE procedure [weekly_ops].[SP_OPS_12_UVLB_Notes_data]
as 
...
--and a.reportweek_yyyyww >= '201301'
...
if object_id('weekly_ops.OPS_12_UVLB_Notes') is not null drop table weekly_ops.OPS_12_UVLB_Notes
select case when a.Scorecard_Program_Channel = 'U-verse Base Acq - Bill Insert' then 'Bill Insert'
	...
	when a.Scorecard_Program_Channel = 'U-verse Base Acq - Catalog - Hisp' then 'Catalog - Hisp'
	...
	into weekly_ops.OPS_12_UVLB_Notes
...
select * from weekly_ops.OPS_12_UVLB_Notes

...
CREATE PROCEDURE [weekly_ops].[SP_OPS_05_UVLB_weeklytvsales]
as 
drop table weekly_ops.OPS_05_UVLB_weeklytvsales
...
into weekly_ops.OPS_05_UVLB_weeklytvsales
...
and a.Campaign_Parent_Name not like '%JUN13_UPRO_D2D_DetroitDoorHanger%'
and Scorecard_Program_Channel not in ('U-verse Base Acq - Direct Marketing Drag','U-verse Base Acq - Direct Marketing Drag Hispanic')
...
select * from weekly_ops.OPS_05_UVLB_weeklytvsales

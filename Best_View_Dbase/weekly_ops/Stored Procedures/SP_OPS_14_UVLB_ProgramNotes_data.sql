...
CREATE procedure [weekly_ops].[SP_OPS_14_UVLB_ProgramNotes_data]
as 
...
SELECT a.[Lookup Name]
  ...
  into #WOWnotes
  FROM [UVAQ].[weekly_ops].[OPS_01_UVLB_currentweek] as a
	join [weekly_ops].[OPS_03_UVLB_previousweek] as b
  ...
  where a.Scorecard_Program_Channel not like '%D2R%'
	...
	and a.Scorecard_Program_Channel not like '%prospect%'
...
if object_id('tempdb..#OPS_14_UVLB_Program_Level_Notes') is not null drop table #OPS_14_UVLB_Program_Level_Notes
create table #OPS_14_UVLB_Program_Level_Notes
 ([Program] varchar(max),
 ...
 insert into #OPS_14_UVLB_Program_Level_Notes ([Program], [Directed Calls Notes])
  SELECT A.[Program], 
  ...
  insert into #OPS_14_UVLB_Program_Level_Notes ([Program], [Directed Online Responses Notes])
  SELECT A.[Program], 
  ...
  insert into #OPS_14_UVLB_Program_Level_Notes ([Program], [Directed Strategic Sales Notes])
  SELECT A.[Program], 
  ...
  insert into #OPS_14_UVLB_Program_Level_Notes ([Program], [Directed TV Sales Notes])
  SELECT A.[Program], 
 ...
 if object_id('weekly_ops.OPS_14_UVLB_Program_Level_Notes') is not null drop table weekly_ops.OPS_14_UVLB_Program_Level_Notes                                                                   
 select program
 ...
 into weekly_ops.OPS_14_UVLB_Program_Level_Notes
  from #OPS_14_UVLB_Program_Level_Notes
  group by program
select * from weekly_ops.OPS_14_UVLB_Program_Level_Notes

...
CREATE PROCEDURE [weekly_ops].[SP_OPS_08_UVLB_TVSalesLagdata]
as 
if object_id('weekly_ops.OPS_08_UVLB_TVSalesLagdata') is not null 
drop table weekly_ops.OPS_08_UVLB_TVSalesLagdata
...
into weekly_ops.OPS_08_UVLB_TVSalesLagdata
from #detail_data
where Scorecard_Program_Channel not like '%drag%'
and Scorecard_Program_Channel not like '%prospect%'
group by reportweek_yyyyww
order by reportweek_yyyyww

select * from weekly_ops.OPS_08_UVLB_TVSalesLagdata

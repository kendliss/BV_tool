...
CREATE PROCEDURE [weekly_ops].[SP_OPS_03_UVLB_previousweek]
as 
...
if object_id('weekly_ops.OPS_03_UVLB_previousweek') is not null drop table weekly_ops.OPS_03_UVLB_previousweek
select 
...
into weekly_ops.OPS_03_UVLB_previousweek
from #LB_prev as a 
...
select * from weekly_ops.OPS_03_UVLB_previousweek

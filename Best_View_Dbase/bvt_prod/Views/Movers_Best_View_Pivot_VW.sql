...
Sum((isnull([Online_sales_Access Line_CV], 0))+ (isnull([Online_sales_DSL_CV], 0))+ (isnull([Online_sales_DSL Direct_CV], 0))+ (isnull([Online_sales_HSIA_CV], 0))+ (isnull([Online_sales_IPDSL_CV], 0))+ (isnull([Online_sales_Satellite_CV], 0))+ (isnull([Online_sales_UVTV_CV], 0))+ (isnull([Online_sales_VoIP_CV], 0))+ (isnull([Online_sales_WRLS Data_CV], 0))+ (isnull([Online_sales_WRLS Family_CV], 0))+ (isnull([Online_sales_WRLS Voice_CV], 0))+ (isnull([Telesales_Access Line_CV], 0))+ (isnull([Telesales_DSL_CV], 0))+ (isnull([Telesales_DSL Direct_CV], 0))+ (isnull([Telesales_HSIA_CV], 0))+ (isnull([Telesales_IPDSL_CV], 0))+ (isnull([Telesales_Satellite_CV], 0))+ (isnull([Telesales_UVTV_CV], 0))+ (isnull([Telesales_VoIP_CV], 0))+ (isnull([Telesales_WRLS Data_CV], 0))+ (isnull([Telesales_WRLS Family_CV], 0))+ (isnull([Telesales_WRLS Voice_CV], 0))) as Online_Strat_CV,
Sum((isnull([Online_sales_Access Line_BV], 0))+ (isnull([Online_sales_DSL_BV], 0))+ (isnull([Online_sales_DSL Direct_BV], 0))+ (isnull([Online_sales_HSIA_BV], 0))+ (isnull([Online_sales_IPDSL_BV], 0))+ (isnull([Online_sales_Satellite_BV], 0))+ (isnull([Online_sales_UVTV_BV], 0))+ (isnull([Online_sales_VoIP_BV], 0))+ (isnull([Online_sales_WRLS Data_BV], 0))+ (isnull([Online_sales_WRLS Family_BV], 0))+ (isnull([Online_sales_WRLS Voice_BV], 0))+ (isnull([Telesales_Access Line_BV], 0))+ (isnull([Telesales_DSL_BV], 0))+ (isnull([Telesales_DSL Direct_BV], 0))+ (isnull([Telesales_HSIA_BV], 0))+ (isnull([Telesales_IPDSL_BV], 0))+ (isnull([Telesales_Satellite_BV], 0))+ (isnull([Telesales_UVTV_BV], 0))+ (isnull([Telesales_VoIP_BV], 0))+ (isnull([Telesales_WRLS Data_BV], 0))+ (isnull([Telesales_WRLS Family_BV], 0))+ (isnull([Telesales_WRLS Voice_BV], 0))) as Online_Strat_BV,
Sum((isnull([Online_sales_Access Line_FV], 0))+ (isnull([Online_sales_DSL_FV], 0))+ (isnull([Online_sales_DSL Direct_FV], 0))+ (isnull([Online_sales_HSIA_FV], 0))+ (isnull([Online_sales_IPDSL_FV], 0))+ (isnull([Online_sales_Satellite_FV], 0))+ (isnull([Online_sales_UVTV_FV], 0))+ (isnull([Online_sales_VoIP_FV], 0))+ (isnull([Online_sales_WRLS Data_FV], 0))+ (isnull([Online_sales_WRLS Family_FV], 0))+ (isnull([Online_sales_WRLS Voice_FV], 0))+ (isnull([Telesales_Access Line_FV], 0))+ (isnull([Telesales_DSL_FV], 0))+ (isnull([Telesales_DSL Direct_FV], 0))+ (isnull([Telesales_HSIA_FV], 0))+ (isnull([Telesales_IPDSL_FV], 0))+ (isnull([Telesales_Satellite_FV], 0))+ (isnull([Telesales_UVTV_FV], 0))+ (isnull([Telesales_VoIP_FV], 0))+ (isnull([Telesales_WRLS Data_FV], 0))+ (isnull([Telesales_WRLS Family_FV], 0))+ (isnull([Telesales_WRLS Voice_FV], 0))) as Online_Strat_FV,
Sum((isnull([Online_sales_Access Line_AV], 0))+ (isnull([Online_sales_DSL_AV], 0))+ (isnull([Online_sales_DSL Direct_AV], 0))+ (isnull([Online_sales_HSIA_AV], 0))+ (isnull([Online_sales_IPDSL_AV], 0))+ (isnull([Online_sales_Satellite_AV], 0))+ (isnull([Online_sales_UVTV_AV], 0))+ (isnull([Online_sales_VoIP_AV], 0))+ (isnull([Online_sales_WRLS Data_AV], 0))+ (isnull([Online_sales_WRLS Family_AV], 0))+ (isnull([Online_sales_WRLS Voice_AV], 0))+ (isnull([Telesales_Access Line_AV], 0))+ (isnull([Telesales_DSL_AV], 0))+ (isnull([Telesales_DSL Direct_AV], 0))+ (isnull([Telesales_HSIA_AV], 0))+ (isnull([Telesales_IPDSL_AV], 0))+ (isnull([Telesales_Satellite_AV], 0))+ (isnull([Telesales_UVTV_AV], 0))+ (isnull([Telesales_VoIP_AV], 0))+ (isnull([Telesales_WRLS Data_AV], 0))+ (isnull([Telesales_WRLS Family_AV], 0))+ (isnull([Telesales_WRLS Voice_AV], 0))) as Online_Strat_AV,
Sum((isnull([Telesales_Access Line_CV], 0))+ (isnull([Telesales_DSL_CV], 0))+ (isnull([Telesales_DSL Direct_CV], 0))+ (isnull([Telesales_HSIA_CV], 0))+ (isnull([Telesales_IPDSL_CV], 0))+ (isnull([Telesales_Satellite_CV], 0))+ (isnull([Telesales_UVTV_CV], 0))+ (isnull([Telesales_VoIP_CV], 0))+ (isnull([Telesales_WRLS Data_CV], 0))+ (isnull([Telesales_WRLS Family_CV], 0))+ (isnull([Telesales_WRLS Voice_CV], 0))+ (isnull([Telesales_Access Line_CV], 0))+ (isnull([Telesales_DSL_CV], 0))+ (isnull([Telesales_DSL Direct_CV], 0))+ (isnull([Telesales_HSIA_CV], 0))+ (isnull([Telesales_IPDSL_CV], 0))+ (isnull([Telesales_Satellite_CV], 0))+ (isnull([Telesales_UVTV_CV], 0))+ (isnull([Telesales_VoIP_CV], 0))+ (isnull([Telesales_WRLS Data_CV], 0))+ (isnull([Telesales_WRLS Family_CV], 0))+ (isnull([Telesales_WRLS Voice_CV], 0))) as Call_Strat_CV,
Sum((isnull([Telesales_Access Line_BV], 0))+ (isnull([Telesales_DSL_BV], 0))+ (isnull([Telesales_DSL Direct_BV], 0))+ (isnull([Telesales_HSIA_BV], 0))+ (isnull([Telesales_IPDSL_BV], 0))+ (isnull([Telesales_Satellite_BV], 0))+ (isnull([Telesales_UVTV_BV], 0))+ (isnull([Telesales_VoIP_BV], 0))+ (isnull([Telesales_WRLS Data_BV], 0))+ (isnull([Telesales_WRLS Family_BV], 0))+ (isnull([Telesales_WRLS Voice_BV], 0))+ (isnull([Telesales_Access Line_BV], 0))+ (isnull([Telesales_DSL_BV], 0))+ (isnull([Telesales_DSL Direct_BV], 0))+ (isnull([Telesales_HSIA_BV], 0))+ (isnull([Telesales_IPDSL_BV], 0))+ (isnull([Telesales_Satellite_BV], 0))+ (isnull([Telesales_UVTV_BV], 0))+ (isnull([Telesales_VoIP_BV], 0))+ (isnull([Telesales_WRLS Data_BV], 0))+ (isnull([Telesales_WRLS Family_BV], 0))+ (isnull([Telesales_WRLS Voice_BV], 0))) as Call_Strat_BV,
Sum((isnull([Telesales_Access Line_FV], 0))+ (isnull([Telesales_DSL_FV], 0))+ (isnull([Telesales_DSL Direct_FV], 0))+ (isnull([Telesales_HSIA_FV], 0))+ (isnull([Telesales_IPDSL_FV], 0))+ (isnull([Telesales_Satellite_FV], 0))+ (isnull([Telesales_UVTV_FV], 0))+ (isnull([Telesales_VoIP_FV], 0))+ (isnull([Telesales_WRLS Data_FV], 0))+ (isnull([Telesales_WRLS Family_FV], 0))+ (isnull([Telesales_WRLS Voice_FV], 0))+ (isnull([Telesales_Access Line_FV], 0))+ (isnull([Telesales_DSL_FV], 0))+ (isnull([Telesales_DSL Direct_FV], 0))+ (isnull([Telesales_HSIA_FV], 0))+ (isnull([Telesales_IPDSL_FV], 0))+ (isnull([Telesales_Satellite_FV], 0))+ (isnull([Telesales_UVTV_FV], 0))+ (isnull([Telesales_VoIP_FV], 0))+ (isnull([Telesales_WRLS Data_FV], 0))+ (isnull([Telesales_WRLS Family_FV], 0))+ (isnull([Telesales_WRLS Voice_FV], 0))) as Call_Strat_FV,
Sum((isnull([Telesales_Access Line_AV], 0))+ (isnull([Telesales_DSL_AV], 0))+ (isnull([Telesales_DSL Direct_AV], 0))+ (isnull([Telesales_HSIA_AV], 0))+ (isnull([Telesales_IPDSL_AV], 0))+ (isnull([Telesales_Satellite_AV], 0))+ (isnull([Telesales_UVTV_AV], 0))+ (isnull([Telesales_VoIP_AV], 0))+ (isnull([Telesales_WRLS Data_AV], 0))+ (isnull([Telesales_WRLS Family_AV], 0))+ (isnull([Telesales_WRLS Voice_AV], 0))+ (isnull([Telesales_Access Line_AV], 0))+ (isnull([Telesales_DSL_AV], 0))+ (isnull([Telesales_DSL Direct_AV], 0))+ (isnull([Telesales_HSIA_AV], 0))+ (isnull([Telesales_IPDSL_AV], 0))+ (isnull([Telesales_Satellite_AV], 0))+ (isnull([Telesales_UVTV_AV], 0))+ (isnull([Telesales_VoIP_AV], 0))+ (isnull([Telesales_WRLS Data_AV], 0))+ (isnull([Telesales_WRLS Family_AV], 0))+ (isnull([Telesales_WRLS Voice_AV], 0))) as Call_Strat_AV
	FROM
		(SELECT  
	[idFlight_Plan_Records_FK], [Campaign_Name], [InHome_Date], [Media_Year], [Media_Week], [Media_Month], [Touch_Name], [Program_Name], [Tactic], [Media], 

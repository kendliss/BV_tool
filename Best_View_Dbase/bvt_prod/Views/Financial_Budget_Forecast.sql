...
create view [bvt_prod].[Financial_Budget_Forecast]
as select 
	...
	from bvt_prod.Flight_Plan_Records
		...
		LEFT join bvt_prod.Flightplan_Volume_Forecast_VW
			on flight_plan_records.idFlight_Plan_Records=Flightplan_Volume_Forecast_VW.idFlight_Plan_Records

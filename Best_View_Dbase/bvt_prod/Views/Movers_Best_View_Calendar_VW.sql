drop view [bvt_prod].[Mover_Best_View_Calendar_VW]
GO
	...
	(SELECT 
      ...
      , a.[Product_Code]) as forecast
		...
		full join 
			...
			where CV_Submission in('Movers 2016 Submission Adj 20160422','Movers CV Restatement Aug 2015','Movers Alt Media 2017 Submission 20161215') --extract_date='2015-08-26'

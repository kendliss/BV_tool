DROP VIEW [bvt_prod].[Mig_Forecast_VW]
GO


CREATE view [bvt_prod].[Mig_Forecast_VW]
as
...
from bvt_prod.Mig_Flight_Plan_VW as FPR
...
from bvt_prod.Mig_FlightplanSalesForecast
 left join bvt_prod.Product_LU_TBL
		on Mig_FlightplanSalesForecast.idProduct_LU_TBL_FK=Product_LU_TBL.idProduct_LU_TBL)
...
from bvt_prod.Mig_FlightplanKPIForecast
 left join bvt_prod.KPI_Types
		on Mig_FlightplanKPIForecast.idkpi_types_FK=KPI_Types.idKPI_Types)
...
(select idFlight_Plan_Records
	...
	, Volume as Forecast
from bvt_prod.Mig_Flightplan_Volume_Forecast_VW)) as metricsa) as metrics

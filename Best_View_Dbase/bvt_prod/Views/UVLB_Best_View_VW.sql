drop view [bvt_prod].[UVLB_Best_View_VW]
GO

CREATE VIEW [bvt_prod].[UVLB_Best_View_VW]
	AS 
	select 
	...
	(SELECT 
      ...
      , Media_Week) as forecast
		...
		full join 
			...
			where CV_Submission in ('UVLB Commitment View 2015', 'UVLB 2016 Submission 20160121') --extract_date='2015-06-26'

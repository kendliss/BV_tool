...
DROP VIEW bvt_prod.BM_Flightplan_SalesRate_Daily_VW
GO
...
from [bvt_prod].[BM_Flight_Plan_VW] as A
	...
	left join (SELECT * FROM [bvt_prod].[Sales_Rate_Start_End_FUN](7)) as B on A.idProgram_Touch_Definitions_TBL_FK=B.idProgram_Touch_Definitions_TBL_FK
...
---End Join Daily Percentages
	...
	left join (SELECT * FROM [bvt_prod].[Sales_Curve_Start_End_FUN](7)) as C

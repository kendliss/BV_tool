...
/****** Object:  View [bvt_prod].[XSell_CCF_CallStrat]    Script Date: 06/09/2016 15:57:54 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [bvt_prod].[XSell_CCF_CallStrat]

	AS	
	
Select a.Touch_Name, a.Media, Campaign_Name, idFlight_Plan_Records, b.Source_System_ID as ParentID, TOllFree_number, a.InHome_Date, Media_Week, SUM(Forecast*ISNULL(PIDPercent,1)) as Calls
, Coalesce(CAST(CallStrat_ID as Varchar(10)),c.Channel) as CallStrat, c.Channel
...
on a.Touch_Name = c.Touch_Name and c.Program_Name = 'X-Sell'
group by a.Touch_Name, a.Media, a.Campaign_Name, idFlight_Plan_Records, b.Source_System_ID, Channel, a.InHome_Date, Media_Week
, Coalesce(CAST(CallStrat_ID AS VARCHAR(10)),c.Channel), TOllFree_number

...
/****** Object:  View [bvt_prod].[UVLB_Forecast_Campaign_Summary_VW]    Script Date: 02/17/2016 14:39:45 ******/
SET ANSI_NULLS ON
GO
...
ALTER View [bvt_prod].[UVLB_Forecast_Campaign_Summary_VW]
as

select KPIs.*, costs.Budget, ISO_Week, MediaMonth, MediaMonth_Year

...
from bvt_prod.Movers_Flight_Plan_VW as A
	...
	left join (SELECT * FROM [bvt_prod].[Sales_Rate_Start_End_FUN](4)) as B
...
---End Join KPI and Flight Plan	
	...
	left join (SELECT * FROM [bvt_prod].[Response_Daily_Start_End_FUN](4)) as B 
...
---End Join Daily Percentages
	...
	left join (SELECT * FROM [bvt_prod].[Sales_Curve_Start_End_FUN](4)) as C
	...
	left join (SELECT * FROM [bvt_prod].[Dropdate_Start_End_FUN](4)) as D

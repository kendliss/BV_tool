drop view [bvt_prod].[ACQ_Best_View_Calendar_VW]
GO

CREATE VIEW [bvt_prod].[ACQ_Best_View_Calendar_VW]
	AS 
	select 
	...
	(SELECT 
      ...
      , a.[Media_YYYYWW]) as forecast
		...
		full join 
			...
			where CV_Submission in ('ACQ 2016 Commitment View Adj 20160509', 'ACQ 2017 Submission 20170221')

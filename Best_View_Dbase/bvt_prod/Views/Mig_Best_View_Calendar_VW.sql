--drop view [bvt_prod].[Mig_Best_View_VW]
--GO

CREATE VIEW [bvt_prod].[Mig_Best_View_Calendar_VW]
	AS 
	select 
...
----Join Actuals
		...
		full outer join 
			...
			inner join bvt_prod.Mig_Flight_Plan_VW on [idFlight_Plan_Records_FK] = [idFlight_Plan_Records]

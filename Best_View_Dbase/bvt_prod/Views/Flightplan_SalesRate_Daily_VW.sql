...
-------------------------------------------
CREATE view [bvt_prod].[Flightplan_SalesRate_Daily_VW]
as
...
(select 
	...
	, InHome_Date
	, idTarget_Rate_Reasons_LU_TBL_FK
from bvt_prod.Flight_Plan_Records as A
	
	left join bvt_processed.Sales_Rates_Start_End as B on A.idProgram_Touch_Definitions_TBL_FK=B.idProgram_Touch_Definitions_TBL_FK

...
(CASE WHEN N%2=1 THEN MAX(CASE WHEN N%2=0 THEN Adj_Start_Date END) OVER (Partition BY (N+1)/2) 
	ELSE MAX(CASE WHEN N%2=1 THEN Adj_Start_Date END) OVER (Partition BY N/2) END)

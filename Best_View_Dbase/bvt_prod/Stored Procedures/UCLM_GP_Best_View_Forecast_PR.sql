...
CREATE procedure [bvt_prod].[UCLM_GP_Best_View_Forecast_PR]
as
set nocount on
...
EXEC bvt_processed.UCLM_GP_Flight_Plan_PR
declare @ts datetime
set @ts = GETDATE()
insert into bvt_processed.UCLM_GP_Best_View_Forecast
select *, @ts from bvt_prod.UCLM_GP_Best_View_Forecast_VW
set nocount off

...
select a.Project_ID, a.Parentid, idFlight_Plan_Records_FK, a.[Report_Year], a.[Report_Week], YEAR(a.Period_Start_Date) as Calendar_Year,
		MONTH(a.Period_Start_Date) as Calendar_Month , a.[Start_Date], a.[End_Date_Traditional], a.[eCRW_Project_Name], a.[Campaign_Name]

...
select a.Project_ID, a.Parentid, idFlight_Plan_Records_FK, a.[Report_Year], a.[Report_Week], a.[Start_Date], a.[End_Date_Traditional], a.[eCRW_Project_Name], a.[Campaign_Name]
		...
		, a.[ITP_Dir_Sales_TS_DSL_IP_N], [ITP_Dir_Sales_TS_UVRS_HSIA_N], a.[ITP_Dir_Sales_TS_UVRS_TV_N], a.[ITP_Dir_Sales_TS_UVRS_BOLT_N]
		...
		, a.[ITP_Dir_Sales_ON_LD_N], a.[ITP_Dir_Sales_ON_DSL_REG_N], a.[ITP_Dir_Sales_ON_DSL_DRY_N], a.[ITP_Dir_Sales_ON_DSL_IP_N], [ITP_Dir_Sales_ON_UVRS_HSIA_N]

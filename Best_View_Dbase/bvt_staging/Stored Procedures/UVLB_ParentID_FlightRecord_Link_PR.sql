...
WHEN Media_Code = 'DM' AND eCRW_Project_Name LIKE '%GIG%' AND (eCRW_Project_Name LIKE '%LAUNCH%' OR Campaign_Name LIKE '%LNCH%') AND (Campaign_Name LIKE '%TOUCH 1%' OR Campaign_Name LIKE '%T1%') AND (Campaign_Name LIKE '%TVUP%' OR Campaign_Name LIKE '%TV UP%') THEN 40--moved with WRLN+ for now 518
WHEN Media_Code = 'DM' AND eCRW_Project_Name LIKE '%GIG%' AND (eCRW_Project_Name LIKE '%LAUNCH%' OR Campaign_Name LIKE '%LNCH%') AND (Campaign_Name LIKE '%TOUCH 1%' OR Campaign_Name LIKE '%T1%') AND Campaign_Name NOT LIKE '%NWLS%' AND Campaign_Name NOT LIKE '%WLN w/%' AND Campaign_Name NOT LIKE '%WLS+%' AND Campaign_Name NOT LIKE '%WLS +%' AND Campaign_Name NOT LIKE '%non wls%' AND Campaign_Name NOT LIKE '%WLSO%'  AND Campaign_Name NOT LIKE '%NWLS%' AND Campaign_Name LIKE '%WLS%' THEN 38
WHEN Media_Code = 'DM' AND eCRW_Project_Name LIKE '%GIG%' AND (eCRW_Project_Name LIKE '%LAUNCH%' OR Campaign_Name LIKE '%LNCH%') AND (Campaign_Name LIKE '%TOUCH 1%' OR Campaign_Name LIKE '%T1%') THEN 40
...
--core email
WHEN Media_Code = 'EM' AND eCRW_Project_Name NOT LIKE '%GIG%' AND (Campaign_Name LIKE '%EARLY%' OR eCRW_Project_Name LIKE '%PostLaunchWeek1and2%') AND Campaign_Name NOT LIKE '%BLAST%' AND Campaign_Name NOT LIKE '% RB%' AND Campaign_Name NOT LIKE '%REDEPLOY%' THEN 124
WHEN Media_Code = 'EM' AND eCRW_Project_Name NOT LIKE '%GIG%' AND (Campaign_Name LIKE '%EARLY%' OR eCRW_Project_Name LIKE '%PostLaunchWeek1and2%') AND (Campaign_Name  LIKE '%BLAST%' OR Campaign_Name  LIKE '%REDEPLOY%' OR Campaign_Name  LIKE '% RB%') THEN 126


WHEN Media_Code = 'EM' AND eCRW_Project_Name NOT LIKE '%GIG%' AND (Campaign_Name LIKE '%MID%' OR eCRW_Project_Name LIKE '%PostLaunchWeek3and4%') AND Campaign_Name NOT LIKE '%BLAST%' AND Campaign_Name NOT LIKE '% RB%' AND Campaign_Name NOT LIKE '%REDEPLOY%' THEN 130
WHEN Media_Code = 'EM' AND eCRW_Project_Name NOT LIKE '%GIG%' AND (Campaign_Name LIKE '%MID%' OR eCRW_Project_Name LIKE '%PostLaunchWeek3and4%') AND (Campaign_Name  LIKE '%BLAST%' OR Campaign_Name  LIKE '%REDEPLOY%' OR Campaign_Name  LIKE '% RB%') THEN 132

DROP Proc [bvt_processed].[UCLM_Forecast_Campaign_Summary_PR]
GO
...
CREATE proc [bvt_processed].[UCLM_Forecast_Campaign_Summary_PR]
as
--declare @lst_load datetime
--select @lst_load = (select MAX(load_dt) from bvt_processed.UCLM_Best_View_Forecast)
...
(select * from
	...
	from bvt_prod.UCLM_Financial_Budget_Forecast

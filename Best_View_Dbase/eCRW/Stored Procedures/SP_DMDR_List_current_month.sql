...
--current month
CREATE PROCEDURE [ecrw].[SP_DMDR_List_current_month] @track_start_date date, @track_end_date date
as

if object_id('[ecrw].[DMDR_List_current_month0]') is not null drop table [ecrw].[DMDR_List_current_month0]
select * into [ecrw].[DMDR_List_current_month0] 
from [ecrw].[DMDR_List_current_month1]

if object_id('[ecrw].[DMDR_List_current_month1]') is not null drop table [ecrw].[DMDR_List_current_month1]
...
,case when (a.parentid IN (select parentid
								from [ecrw].[DMDR_List_current_month0] as a 
								group by parentid) 
...
into [ecrw].[DMDR_List_current_month1]
...
select * from [ecrw].[DMDR_List_current_month1]
